      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/learner" className="text-gray-300 hover:text-[#00FFB2] transition-colors">
              For Learners
            </Link>
            <Link href="/mentor" className="text-gray-300 hover:text-[#00FFB2] transition-colors">
              For Mentors
            </Link>
            <Link href="/pricing" className="text-gray-300 hover:text-[#00FFB2] transition-colors">
              Pricing
            </Link>
          </div>
            ...
            <div className="relative">
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 glass-card py-2 shadow-lg">
                  <Link href="/profile" className="flex items-center px-4 py-2 text-sm hover:bg-[#00FFB2]/10">
                    <Settings size={16} className="mr-3" />
                    Profile Settings
                  </Link>
                  <button className="flex items-center w-full px-4 py-2 text-sm hover:bg-[#00FFB2]/10 text-red-400">
