...
export default function MentorDashboard() {
  ...
  const recentReviews = [
    { student: 'Sarah Chen', rating: 5, comment: 'Incredible mentor! Really helped me understand system design concepts.' },
    { student: 'Michael Brown', rating: 5, comment: 'Patient and knowledgeable. Great at explaining complex topics.' },
    { student: 'Jessica Wang', rating: 4, comment: 'Very helpful session. Looking forward to our next meeting.' }
  ];
        ...
        <div className="container-custom">
          ...
          <div className={`mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-gray-400 text-lg">Ready to help shape some careers today?</p>
              </div>
              <div className="flex items-center space-x-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#00FFB2]">$2.8k</div>
            ...
            <div className="glass-card p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-blue-400">+3 from last week</div>
                </div>
              </div>
            ...
            <div className="glass-card p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-purple-400">+7 new this month</div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
            ...
            <div className="lg:col-span-2 glass-card p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/mentor/sessions" className="btn-outline flex items-center text-sm">
                  View All
              ...
              <div className="space-y-4">
                {upcomingSessions.map((session, index) => (
                  <div key={index} className="flex items-center justify-between p-4 bg-[#1A1A1A] rounded-lg card-hover">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-[#00FFB2]">{session.time}</div>
                      </div>
                    </div>
              ...
              <div className="mt-6 p-4 bg-[#1A1A1A] rounded-lg border-2 border-dashed border-gray-600">
                <div className="text-center">
                  ...
                  <div className="text-gray-400 mb-3">No more sessions today</div>
                  <Link href="/mentor/availability" className="btn-primary inline-flex items-center text-sm">
                    Update Availability
                  </Link>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="w-full bg-[#1A1A1A] rounded-full h-2">
                      <div className="bg-gradient-to-r from-[#00FFB2] to-[#00CC8E] h-2 rounded-full" style={{width: '80%'}}></div>
                    </div>
                  </div>
                ...
                <Link href="/mentor/earnings" className="btn-outline w-full mt-4 py-2 text-center block text-sm">
              ...
              <div className="glass-card p-6">
                ...
                <Link href="/mentor/profile" className="btn-outline w-full py-2 text-center block text-sm">
                  Update Profile
                </Link>
              </div>
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-3">
                  <Link href="/mentor/availability" className="flex items-center p-3 bg-[#1A1A1A] rounded-lg hover:bg-[#00FFB2]/10 transition-colors">
                    <Calendar size={16} className="text-[#00FFB2] mr-3" />
                    <span className="text-sm">Set Availability</span>
                  </Link>
                  
                  <Link href="/mentor/resources" className="flex items-center p-3 bg-[#1A1A1A] rounded-lg hover:bg-[#00FFB2]/10 transition-colors">
                    <BookOpen size={16} className="text-[#00FFB2] mr-3" />
                    <span className="text-sm">Learning Resources</span>
                  </Link>
                  
                  <Link href="/mentor/analytics" className="flex items-center p-3 bg-[#1A1A1A] rounded-lg hover:bg-[#00FFB2]/10 transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-6">
              ...
              <Link href="/mentor/reviews" className="btn-outline w-full mt-4 py-2 text-center block text-sm">
                View All Reviews
              </Link>
            </div>
            ...
            <div className="glass-card p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-[#1A1A1A] rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="text-xl font-bold text-[#00FFB2]">{'< 2h'}</div>
                ...
                <div className="flex items-center justify-between p-4 bg-[#1A1A1A] rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Profile to booking</div>
                  </div>
                  <div className="text-right">
                    <div className="text-xl font-bold text-[#00FFB2]">78%</div>
                ...
                <div className="flex items-center justify-between p-4 bg-[#1A1A1A] rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="text-xl font-bold text-[#00FFB2]">96%</div>
