...
export default function LearnerDashboard() {
  ...
  const recentScores = [
    { date: '2024-01-15', role: 'Software Engineer', score: 85, improvement: '+12%' },
    { date: '2024-01-12', role: 'Product Manager', score: 78, improvement: '+8%' },
    { date: '2024-01-10', role: 'Data Scientist', score: 92, improvement: '+15%' },
  ];
      ...
      <div className="ml-64 pt-20 pb-12">
        <div className="container-custom">
          ...
          <div className={`mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div>
                ...
                <p className="text-gray-400 text-lg">Ready to take your career to the next level?</p>
              </div>
              <div className="flex items-center space-x-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#00FFB2]">15</div>
                  <div className="text-sm text-gray-400">Interviews</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#00FFB2]">87%</div>
                  <div className="text-sm text-gray-400">Avg Score</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-[#00FFB2]">3</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="lg:col-span-2 glass-card p-8 neon-glow card-hover">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                ...
                <div className="bg-[#1A1A1A] rounded-lg p-4 text-center">
                  <BookOpen size={24} className="text-[#00FFB2] mx-auto mb-2" />
                  <div className="font-semibold">Case Study</div>
                  <div className="text-sm text-gray-400">60 min</div>
                </div>
              </div>
              
              <Link href="/learner/interview" className="btn-primary flex items-center justify-center w-full py-3">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="w-full bg-[#1A1A1A] rounded-full h-2">
                    <div className="bg-gradient-to-r from-[#00FFB2] to-[#00CC8E] h-2 rounded-full" style={{width: '87%'}}></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-[#1A1A1A] rounded-full h-2">
                    <div className="bg-gradient-to-r from-[#00FFB2] to-[#00CC8E] h-2 rounded-full" style={{width: '92%'}}></div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="w-full bg-[#1A1A1A] rounded-full h-2">
                    <div className="bg-gradient-to-r from-[#00FFB2] to-[#00CC8E] h-2 rounded-full" style={{width: '79%'}}></div>
                  </div>
                </div>
              </div>
              
              <Link href="/learner/scorecard" className="btn-outline w-full mt-4 py-2 text-center block">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className="glass-card p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-semibold">Recent Interview Scores</h3>
                ...
                {recentScores.map((interview, index) => (
                  <div key={index} className="flex items-center justify-between p-4 bg-[#1A1A1A] rounded-lg">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-[#00FFB2]">{interview.score}%</div>
                      <div className="text-sm text-green-400">{interview.improvement}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="glass-card p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 bg-[#1A1A1A] rounded-lg">
                  ...
                  <div className="flex-1">
                    <div className="font-semibold">1:1 Mentorship with Sarah Chen</div>
                    <div className="text-sm text-gray-400">Tomorrow, 2:00 PM</div>
                  </div>
                  <div className="text-right">
                    <div className="text-sm text-[#00FFB2]">System Design</div>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-[#1A1A1A] rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-sm text-gray-400">Friday, 10:00 AM</div>
                  </div>
                  <div className="text-right">
              ...
              <Link href="/learner/sessions" className="btn-outline w-full mt-4 py-2 text-center block">
                Manage Sessions
              </Link>
            </div>
          </div>
          ...
          <div className="glass-card p-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-2xl font-semibold mb-2">Recommended Mentors</h3>
                <p className="text-gray-400">Based on your skill gaps and career goals</p>
              </div>
              <Link href="/learner/mentors" className="btn-outline flex items-center">
                View All
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendedMentors.map((mentor, index) => (
                <div key={index} className="bg-[#1A1A1A] rounded-lg p-6 card-hover">
                  ...
                  <div className="mb-4">
                    <div className="text-sm text-gray-400 mb-1">{mentor.company}</div>
                    <div className="flex items-center mb-2">
                      <Star size={16} className="text-yellow-400 mr-1" />
                      <span className="text-sm font-medium">{mentor.rating}</span>
                      <span className="text-sm text-gray-400 ml-2">{mentor.price}</span>
                    </div>
                  </div>
                  ...
                  <div className="mb-4">
                    <div className="flex flex-wrap gap-2">
                      {mentor.expertise.slice(0, 2).map((skill, skillIndex) => (
                        <span key={skillIndex} className="text-xs bg-[#00FFB2]/20 text-[#00FFB2] px-2 py-1 rounded">
                          {skill}
                        </span>
                      ))}
                      {mentor.expertise.length > 2 && (
                        <span className="text-xs text-gray-400">+{mentor.expertise.length - 2} more</span>
                      )}
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center p-4 bg-[#1A1A1A] rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Completed 5 interviews in a row</div>
                  </div>
                </div>
                ...
                <div className="flex items-center p-4 bg-[#1A1A1A] rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Improved score by 15% in one week</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-6 border-2 border-[#00FFB2]/30">
              ...
              <p className="text-gray-400 mb-4">
                Unlock unlimited interviews, premium mentors, and advanced analytics.
              </p>
              ...
              <Link href="/pricing" className="btn-primary w-full py-3 text-center block">
                Upgrade to Pro
              </Link>
            </div>
          </div>
