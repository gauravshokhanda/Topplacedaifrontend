...
export default function LearnerProfilePage() {
  ...
  const handleResumeUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const response = await fetch(`${API_URL}/users/${user?.id}/resume`, {
        method: 'POST',
        headers: {
              ...
              <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                <div className="glass-card p-8 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
                  <div className="flex items-center justify-between mb-6">
                    <h3 className="text-2xl font-semibold">Extracted Resume Data</h3>
                    <button
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-1">
                          {extractedData.skills.map((skill, index) => (
                            <span key={index} className="px-3 py-1 bg-[#00FFB2]/20 text-[#00FFB2] rounded-full text-sm">
                              {skill}
                            </span>
                          ))}
                        </div>
              ...
              <div className="glass-card p-6">
                  ...
                  <div className="bg-[#1A1A1A] rounded-lg p-4 border border-gray-600 mb-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-white">{uploadedResume.filename}</div>
                          <div className="text-sm text-gray-400">Uploaded on {uploadedResume.uploadDate}</div>
                        </div>
                      </div>
                ...
                <div className="border-2 border-dashed border-gray-600 rounded-lg p-8 text-center">
                  ...
                  <p className="text-gray-400 mb-4">
                    Upload a PDF resume and let AI extract your information automatically
                  </p>
                ...
                <div className="space-y-6">
                  {profileData.experience.length > 0 ? (
                        ...
                        {isEditing ? (
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <Input
                                value={exp.duration}
                                onChange={(e) => handleExperienceUpdate(index, 'duration', e.target.value)}
                    ...
                    <div className="text-center py-8">
                      ...
                      {isEditing && (
                        <button onClick={handleExperienceAdd} className="btn-outline">
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-6">
                  {profileData.education.length > 0 ? (
                        ...
                        {isEditing ? (
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              <Input
                                value={edu.year}
                                onChange={(e) => handleEducationUpdate(index, 'year', e.target.value)}
                    ...
                    <div className="text-center py-8">
                      <GraduationCap size={48} className="text-gray-500 mx-auto mb-4" />
                      <p className="text-gray-400 mb-4">No education added yet</p>
                      {isEditing && (
                        <button onClick={handleEducationAdd} className="btn-outline">
                          Add Your Education
                        </button>
                      )}
                    </div>
              ...
              <div className="glass-card p-6">
                ...
                {isEditing ? (
                  ...
                  <div className="bg-[#1A1A1A] rounded-lg p-4 border border-gray-600">
                    <p className="text-gray-300 leading-relaxed">{profileData.goals}</p>
                  </div>
                ) : (
                  <div className="text-center py-8">
                  ...
                  <div className="bg-[#1A1A1A] p-4 rounded-lg text-center">
                    <div className="text-[#00FFB2] text-2xl font-bold">
                      {Math.round(
                        ...
                        (uploadedResume ? 1 : 0)) / 9 * 100
                      )}%
                    </div>
                    <div className="text-sm text-gray-400">Profile Completion</div>
                  </div>
                  <div className="bg-[#1A1A1A] p-4 rounded-lg text-center">
                    <div className="text-[#00FFB2] text-2xl font-bold">{profileData.skills.length}</div>
                    <div className="text-sm text-gray-400">Skills</div>
                  </div>
                  <div className="bg-[#1A1A1A] p-4 rounded-lg text-center">
                    <div className="text-[#00FFB2] text-2xl font-bold">{profileData.experience.length}</div>
                    <div className="text-sm text-gray-400">Experience</div>
                  </div>
                  <div className="bg-[#1A1A1A] p-4 rounded-lg text-center">
                    <div className="text-[#00FFB2] text-2xl font-bold">{profileData.education.length}</div>
